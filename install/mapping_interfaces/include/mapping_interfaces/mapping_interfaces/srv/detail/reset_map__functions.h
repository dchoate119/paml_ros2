...
#ifndef MAPPING_INTERFACES__SRV__DETAIL__RESET_MAP__FUNCTIONS_H_
#define MAPPING_INTERFACES__SRV__DETAIL__RESET_MAP__FUNCTIONS_H_
 ...
 * )) before or use
 * mapping_interfaces__srv__ResetMap_Request__create()
 ...
 * calls
 * mapping_interfaces__srv__ResetMap_Request__init().
...
/**
 * It calls
 * mapping_interfaces__srv__ResetMap_Request__fini()
 ...
 * mapping_interfaces__srv__ResetMap_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * mapping_interfaces__srv__ResetMap_Request__Sequence__fini()
 * on the array,
 ...
 * )) before or use
 * mapping_interfaces__srv__ResetMap_Response__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_mapping_interfaces
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * mapping_interfaces__srv__ResetMap_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_mapping_interfaces
...
/**
 * It calls
 * mapping_interfaces__srv__ResetMap_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_mapping_interfaces
...
/**
 * It allocates the memory for the array and calls
 * mapping_interfaces__srv__ResetMap_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_mapping_interfaces
...
/**
 * It calls
 * mapping_interfaces__srv__ResetMap_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * )) before or use
 * mapping_interfaces__srv__ResetMap_Event__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_mapping_interfaces
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * mapping_interfaces__srv__ResetMap_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_mapping_interfaces
...
/**
 * It calls
 * mapping_interfaces__srv__ResetMap_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_mapping_interfaces
...
/**
 * It allocates the memory for the array and calls
 * mapping_interfaces__srv__ResetMap_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_mapping_interfaces
...
/**
 * It calls
 * mapping_interfaces__srv__ResetMap_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // MAPPING_INTERFACES__SRV__DETAIL__RESET_MAP__FUNCTIONS_H_
