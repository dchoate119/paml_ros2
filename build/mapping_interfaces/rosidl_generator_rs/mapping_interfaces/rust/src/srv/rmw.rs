...
#[link(name = "mapping_interfaces__rosidl_typesupport_c")]
extern "C" {
    fn rosidl_typesupport_c__get_message_type_support_handle__mapping_interfaces__srv__CaptureFrame_Request() -> *const std::ffi::c_void;
}

#[link(name = "mapping_interfaces__rosidl_generator_c")]
extern "C" {
    fn mapping_interfaces__srv__CaptureFrame_Request__init(msg: *mut CaptureFrame_Request) -> bool;
    fn mapping_interfaces__srv__CaptureFrame_Request__Sequence__init(seq: *mut rosidl_runtime_rs::Sequence<CaptureFrame_Request>, size: usize) -> bool;
    fn mapping_interfaces__srv__CaptureFrame_Request__Sequence__fini(seq: *mut rosidl_runtime_rs::Sequence<CaptureFrame_Request>);
    fn mapping_interfaces__srv__CaptureFrame_Request__Sequence__copy(in_seq: &rosidl_runtime_rs::Sequence<CaptureFrame_Request>, out_seq: *mut rosidl_runtime_rs::Sequence<CaptureFrame_Request>) -> bool;
}
...
impl Default for CaptureFrame_Request {
  fn default() -> Self {
    unsafe {
      let mut msg = std::mem::zeroed();
      if !mapping_interfaces__srv__CaptureFrame_Request__init(&mut msg as *mut _) {
        panic!("Call to mapping_interfaces__srv__CaptureFrame_Request__init() failed");
      }
      msg
    }
  }
...
impl rosidl_runtime_rs::SequenceAlloc for CaptureFrame_Request {
  fn sequence_init(seq: &mut rosidl_runtime_rs::Sequence<Self>, size: usize) -> bool {
    // SAFETY: This is safe since the pointer is guaranteed to be valid/initialized.
    unsafe { mapping_interfaces__srv__CaptureFrame_Request__Sequence__init(seq as *mut _, size) }
  }
  fn sequence_fini(seq: &mut rosidl_runtime_rs::Sequence<Self>) {
    // SAFETY: This is safe since the pointer is guaranteed to be valid/initialized.
    unsafe { mapping_interfaces__srv__CaptureFrame_Request__Sequence__fini(seq as *mut _) }
  }
  fn sequence_copy(in_seq: &rosidl_runtime_rs::Sequence<Self>, out_seq: &mut rosidl_runtime_rs::Sequence<Self>) -> bool {
    // SAFETY: This is safe since the pointer is guaranteed to be valid/initialized.
    unsafe { mapping_interfaces__srv__CaptureFrame_Request__Sequence__copy(in_seq, out_seq as *mut _) }
  }
}
...
impl rosidl_runtime_rs::RmwMessage for CaptureFrame_Request where Self: Sized {
  const TYPE_NAME: &'static str = "mapping_interfaces/srv/CaptureFrame_Request";
  fn get_type_support() -> *const std::ffi::c_void {
    // SAFETY: No preconditions for this function.
    unsafe { rosidl_typesupport_c__get_message_type_support_handle__mapping_interfaces__srv__CaptureFrame_Request() }
  }
}
...
#[link(name = "mapping_interfaces__rosidl_typesupport_c")]
extern "C" {
    fn rosidl_typesupport_c__get_message_type_support_handle__mapping_interfaces__srv__CaptureFrame_Response() -> *const std::ffi::c_void;
}

#[link(name = "mapping_interfaces__rosidl_generator_c")]
extern "C" {
    fn mapping_interfaces__srv__CaptureFrame_Response__init(msg: *mut CaptureFrame_Response) -> bool;
    fn mapping_interfaces__srv__CaptureFrame_Response__Sequence__init(seq: *mut rosidl_runtime_rs::Sequence<CaptureFrame_Response>, size: usize) -> bool;
    fn mapping_interfaces__srv__CaptureFrame_Response__Sequence__fini(seq: *mut rosidl_runtime_rs::Sequence<CaptureFrame_Response>);
    fn mapping_interfaces__srv__CaptureFrame_Response__Sequence__copy(in_seq: &rosidl_runtime_rs::Sequence<CaptureFrame_Response>, out_seq: *mut rosidl_runtime_rs::Sequence<CaptureFrame_Response>) -> bool;
}
...
pub struct CaptureFrame_Response {
    ...
    // This member is not documented.
    #[allow(missing_docs)]
    pub camera_pose: geometry_msgs::msg::rmw::TransformStamped,
...
impl Default for CaptureFrame_Response {
  fn default() -> Self {
    unsafe {
      let mut msg = std::mem::zeroed();
      if !mapping_interfaces__srv__CaptureFrame_Response__init(&mut msg as *mut _) {
        panic!("Call to mapping_interfaces__srv__CaptureFrame_Response__init() failed");
      }
      msg
    }
  }
...
impl rosidl_runtime_rs::SequenceAlloc for CaptureFrame_Response {
  fn sequence_init(seq: &mut rosidl_runtime_rs::Sequence<Self>, size: usize) -> bool {
    // SAFETY: This is safe since the pointer is guaranteed to be valid/initialized.
    unsafe { mapping_interfaces__srv__CaptureFrame_Response__Sequence__init(seq as *mut _, size) }
  }
  fn sequence_fini(seq: &mut rosidl_runtime_rs::Sequence<Self>) {
    // SAFETY: This is safe since the pointer is guaranteed to be valid/initialized.
    unsafe { mapping_interfaces__srv__CaptureFrame_Response__Sequence__fini(seq as *mut _) }
  }
  fn sequence_copy(in_seq: &rosidl_runtime_rs::Sequence<Self>, out_seq: &mut rosidl_runtime_rs::Sequence<Self>) -> bool {
    // SAFETY: This is safe since the pointer is guaranteed to be valid/initialized.
    unsafe { mapping_interfaces__srv__CaptureFrame_Response__Sequence__copy(in_seq, out_seq as *mut _) }
  }
}
...
impl rosidl_runtime_rs::RmwMessage for CaptureFrame_Response where Self: Sized {
  const TYPE_NAME: &'static str = "mapping_interfaces/srv/CaptureFrame_Response";
  fn get_type_support() -> *const std::ffi::c_void {
    // SAFETY: No preconditions for this function.
    unsafe { rosidl_typesupport_c__get_message_type_support_handle__mapping_interfaces__srv__CaptureFrame_Response() }
  }
}
...
#[link(name = "mapping_interfaces__rosidl_typesupport_c")]
extern "C" {
    fn rosidl_typesupport_c__get_message_type_support_handle__mapping_interfaces__srv__IntegrateFrame_Request() -> *const std::ffi::c_void;
}

#[link(name = "mapping_interfaces__rosidl_generator_c")]
extern "C" {
    fn mapping_interfaces__srv__IntegrateFrame_Request__init(msg: *mut IntegrateFrame_Request) -> bool;
    fn mapping_interfaces__srv__IntegrateFrame_Request__Sequence__init(seq: *mut rosidl_runtime_rs::Sequence<IntegrateFrame_Request>, size: usize) -> bool;
    fn mapping_interfaces__srv__IntegrateFrame_Request__Sequence__fini(seq: *mut rosidl_runtime_rs::Sequence<IntegrateFrame_Request>);
    fn mapping_interfaces__srv__IntegrateFrame_Request__Sequence__copy(in_seq: &rosidl_runtime_rs::Sequence<IntegrateFrame_Request>, out_seq: *mut rosidl_runtime_rs::Sequence<IntegrateFrame_Request>) -> bool;
}
...
impl Default for IntegrateFrame_Request {
  fn default() -> Self {
    unsafe {
      let mut msg = std::mem::zeroed();
      if !mapping_interfaces__srv__IntegrateFrame_Request__init(&mut msg as *mut _) {
        panic!("Call to mapping_interfaces__srv__IntegrateFrame_Request__init() failed");
      }
      msg
    }
  }
...
impl rosidl_runtime_rs::SequenceAlloc for IntegrateFrame_Request {
  fn sequence_init(seq: &mut rosidl_runtime_rs::Sequence<Self>, size: usize) -> bool {
    // SAFETY: This is safe since the pointer is guaranteed to be valid/initialized.
    unsafe { mapping_interfaces__srv__IntegrateFrame_Request__Sequence__init(seq as *mut _, size) }
  }
  fn sequence_fini(seq: &mut rosidl_runtime_rs::Sequence<Self>) {
    // SAFETY: This is safe since the pointer is guaranteed to be valid/initialized.
    unsafe { mapping_interfaces__srv__IntegrateFrame_Request__Sequence__fini(seq as *mut _) }
  }
  fn sequence_copy(in_seq: &rosidl_runtime_rs::Sequence<Self>, out_seq: &mut rosidl_runtime_rs::Sequence<Self>) -> bool {
    // SAFETY: This is safe since the pointer is guaranteed to be valid/initialized.
    unsafe { mapping_interfaces__srv__IntegrateFrame_Request__Sequence__copy(in_seq, out_seq as *mut _) }
  }
}
...
impl rosidl_runtime_rs::RmwMessage for IntegrateFrame_Request where Self: Sized {
  const TYPE_NAME: &'static str = "mapping_interfaces/srv/IntegrateFrame_Request";
  fn get_type_support() -> *const std::ffi::c_void {
    // SAFETY: No preconditions for this function.
    unsafe { rosidl_typesupport_c__get_message_type_support_handle__mapping_interfaces__srv__IntegrateFrame_Request() }
  }
}
...
#[link(name = "mapping_interfaces__rosidl_typesupport_c")]
extern "C" {
    fn rosidl_typesupport_c__get_message_type_support_handle__mapping_interfaces__srv__IntegrateFrame_Response() -> *const std::ffi::c_void;
}

#[link(name = "mapping_interfaces__rosidl_generator_c")]
extern "C" {
    fn mapping_interfaces__srv__IntegrateFrame_Response__init(msg: *mut IntegrateFrame_Response) -> bool;
    fn mapping_interfaces__srv__IntegrateFrame_Response__Sequence__init(seq: *mut rosidl_runtime_rs::Sequence<IntegrateFrame_Response>, size: usize) -> bool;
    fn mapping_interfaces__srv__IntegrateFrame_Response__Sequence__fini(seq: *mut rosidl_runtime_rs::Sequence<IntegrateFrame_Response>);
    fn mapping_interfaces__srv__IntegrateFrame_Response__Sequence__copy(in_seq: &rosidl_runtime_rs::Sequence<IntegrateFrame_Response>, out_seq: *mut rosidl_runtime_rs::Sequence<IntegrateFrame_Response>) -> bool;
}
...
impl Default for IntegrateFrame_Response {
  fn default() -> Self {
    unsafe {
      let mut msg = std::mem::zeroed();
      if !mapping_interfaces__srv__IntegrateFrame_Response__init(&mut msg as *mut _) {
        panic!("Call to mapping_interfaces__srv__IntegrateFrame_Response__init() failed");
      }
      msg
    }
  }
...
impl rosidl_runtime_rs::SequenceAlloc for IntegrateFrame_Response {
  fn sequence_init(seq: &mut rosidl_runtime_rs::Sequence<Self>, size: usize) -> bool {
    // SAFETY: This is safe since the pointer is guaranteed to be valid/initialized.
    unsafe { mapping_interfaces__srv__IntegrateFrame_Response__Sequence__init(seq as *mut _, size) }
  }
  fn sequence_fini(seq: &mut rosidl_runtime_rs::Sequence<Self>) {
    // SAFETY: This is safe since the pointer is guaranteed to be valid/initialized.
    unsafe { mapping_interfaces__srv__IntegrateFrame_Response__Sequence__fini(seq as *mut _) }
  }
  fn sequence_copy(in_seq: &rosidl_runtime_rs::Sequence<Self>, out_seq: &mut rosidl_runtime_rs::Sequence<Self>) -> bool {
    // SAFETY: This is safe since the pointer is guaranteed to be valid/initialized.
    unsafe { mapping_interfaces__srv__IntegrateFrame_Response__Sequence__copy(in_seq, out_seq as *mut _) }
  }
}
...
impl rosidl_runtime_rs::RmwMessage for IntegrateFrame_Response where Self: Sized {
  const TYPE_NAME: &'static str = "mapping_interfaces/srv/IntegrateFrame_Response";
  fn get_type_support() -> *const std::ffi::c_void {
    // SAFETY: No preconditions for this function.
    unsafe { rosidl_typesupport_c__get_message_type_support_handle__mapping_interfaces__srv__IntegrateFrame_Response() }
  }
}
...
#[link(name = "mapping_interfaces__rosidl_typesupport_c")]
extern "C" {
    fn rosidl_typesupport_c__get_message_type_support_handle__mapping_interfaces__srv__ResetMap_Request() -> *const std::ffi::c_void;
}

#[link(name = "mapping_interfaces__rosidl_generator_c")]
extern "C" {
    fn mapping_interfaces__srv__ResetMap_Request__init(msg: *mut ResetMap_Request) -> bool;
    fn mapping_interfaces__srv__ResetMap_Request__Sequence__init(seq: *mut rosidl_runtime_rs::Sequence<ResetMap_Request>, size: usize) -> bool;
    fn mapping_interfaces__srv__ResetMap_Request__Sequence__fini(seq: *mut rosidl_runtime_rs::Sequence<ResetMap_Request>);
    fn mapping_interfaces__srv__ResetMap_Request__Sequence__copy(in_seq: &rosidl_runtime_rs::Sequence<ResetMap_Request>, out_seq: *mut rosidl_runtime_rs::Sequence<ResetMap_Request>) -> bool;
}

// Corresponds to mapping_interfaces__srv__ResetMap_Request
#[cfg_attr(feature = "serde", derive(Deserialize, Serialize))]
...
impl Default for ResetMap_Request {
  fn default() -> Self {
    unsafe {
      let mut msg = std::mem::zeroed();
      if !mapping_interfaces__srv__ResetMap_Request__init(&mut msg as *mut _) {
        panic!("Call to mapping_interfaces__srv__ResetMap_Request__init() failed");
      }
      msg
    }
  }
...
impl rosidl_runtime_rs::SequenceAlloc for ResetMap_Request {
  fn sequence_init(seq: &mut rosidl_runtime_rs::Sequence<Self>, size: usize) -> bool {
    // SAFETY: This is safe since the pointer is guaranteed to be valid/initialized.
    unsafe { mapping_interfaces__srv__ResetMap_Request__Sequence__init(seq as *mut _, size) }
  }
  fn sequence_fini(seq: &mut rosidl_runtime_rs::Sequence<Self>) {
    // SAFETY: This is safe since the pointer is guaranteed to be valid/initialized.
    unsafe { mapping_interfaces__srv__ResetMap_Request__Sequence__fini(seq as *mut _) }
  }
  fn sequence_copy(in_seq: &rosidl_runtime_rs::Sequence<Self>, out_seq: &mut rosidl_runtime_rs::Sequence<Self>) -> bool {
    // SAFETY: This is safe since the pointer is guaranteed to be valid/initialized.
    unsafe { mapping_interfaces__srv__ResetMap_Request__Sequence__copy(in_seq, out_seq as *mut _) }
  }
}

impl rosidl_runtime_rs::Message for ResetMap_Request {
  type RmwMsg = Self;
  fn into_rmw_message(msg_cow: std::borrow::Cow<'_, Self>) -> std::borrow::Cow<'_, Self::RmwMsg> { msg_cow }
  fn from_rmw_message(msg: Self::RmwMsg) -> Self { msg }
}

impl rosidl_runtime_rs::RmwMessage for ResetMap_Request where Self: Sized {
  const TYPE_NAME: &'static str = "mapping_interfaces/srv/ResetMap_Request";
  fn get_type_support() -> *const std::ffi::c_void {
    // SAFETY: No preconditions for this function.
    unsafe { rosidl_typesupport_c__get_message_type_support_handle__mapping_interfaces__srv__ResetMap_Request() }
  }
}
...
#[link(name = "mapping_interfaces__rosidl_typesupport_c")]
extern "C" {
    fn rosidl_typesupport_c__get_message_type_support_handle__mapping_interfaces__srv__ResetMap_Response() -> *const std::ffi::c_void;
}

#[link(name = "mapping_interfaces__rosidl_generator_c")]
extern "C" {
    fn mapping_interfaces__srv__ResetMap_Response__init(msg: *mut ResetMap_Response) -> bool;
    fn mapping_interfaces__srv__ResetMap_Response__Sequence__init(seq: *mut rosidl_runtime_rs::Sequence<ResetMap_Response>, size: usize) -> bool;
    fn mapping_interfaces__srv__ResetMap_Response__Sequence__fini(seq: *mut rosidl_runtime_rs::Sequence<ResetMap_Response>);
    fn mapping_interfaces__srv__ResetMap_Response__Sequence__copy(in_seq: &rosidl_runtime_rs::Sequence<ResetMap_Response>, out_seq: *mut rosidl_runtime_rs::Sequence<ResetMap_Response>) -> bool;
}

// Corresponds to mapping_interfaces__srv__ResetMap_Response
#[cfg_attr(feature = "serde", derive(Deserialize, Serialize))]
...
impl Default for ResetMap_Response {
  fn default() -> Self {
    unsafe {
      let mut msg = std::mem::zeroed();
      if !mapping_interfaces__srv__ResetMap_Response__init(&mut msg as *mut _) {
        panic!("Call to mapping_interfaces__srv__ResetMap_Response__init() failed");
      }
      msg
    }
  }
...
impl rosidl_runtime_rs::SequenceAlloc for ResetMap_Response {
  fn sequence_init(seq: &mut rosidl_runtime_rs::Sequence<Self>, size: usize) -> bool {
    // SAFETY: This is safe since the pointer is guaranteed to be valid/initialized.
    unsafe { mapping_interfaces__srv__ResetMap_Response__Sequence__init(seq as *mut _, size) }
  }
  fn sequence_fini(seq: &mut rosidl_runtime_rs::Sequence<Self>) {
    // SAFETY: This is safe since the pointer is guaranteed to be valid/initialized.
    unsafe { mapping_interfaces__srv__ResetMap_Response__Sequence__fini(seq as *mut _) }
  }
  fn sequence_copy(in_seq: &rosidl_runtime_rs::Sequence<Self>, out_seq: &mut rosidl_runtime_rs::Sequence<Self>) -> bool {
    // SAFETY: This is safe since the pointer is guaranteed to be valid/initialized.
    unsafe { mapping_interfaces__srv__ResetMap_Response__Sequence__copy(in_seq, out_seq as *mut _) }
  }
}

impl rosidl_runtime_rs::Message for ResetMap_Response {
  type RmwMsg = Self;
  fn into_rmw_message(msg_cow: std::borrow::Cow<'_, Self>) -> std::borrow::Cow<'_, Self::RmwMsg> { msg_cow }
  fn from_rmw_message(msg: Self::RmwMsg) -> Self { msg }
}

impl rosidl_runtime_rs::RmwMessage for ResetMap_Response where Self: Sized {
  const TYPE_NAME: &'static str = "mapping_interfaces/srv/ResetMap_Response";
  fn get_type_support() -> *const std::ffi::c_void {
    // SAFETY: No preconditions for this function.
    unsafe { rosidl_typesupport_c__get_message_type_support_handle__mapping_interfaces__srv__ResetMap_Response() }
  }
}
...
#[link(name = "mapping_interfaces__rosidl_typesupport_c")]
extern "C" {
    fn rosidl_typesupport_c__get_service_type_support_handle__mapping_interfaces__srv__ResetMap() -> *const std::ffi::c_void;
}

// Corresponds to mapping_interfaces__srv__ResetMap
#[allow(missing_docs, non_camel_case_types)]
pub struct ResetMap;

impl rosidl_runtime_rs::Service for ResetMap {
    type Request = ResetMap_Request;
    type Response = ResetMap_Response;

    fn get_type_support() -> *const std::ffi::c_void {
        // SAFETY: No preconditions for this function.
        unsafe { rosidl_typesupport_c__get_service_type_support_handle__mapping_interfaces__srv__ResetMap() }
    }
}
